...
public class DecorationsController : MonoBehaviour
{
    ...
    /// キャラクターカスタマイズ
    /// </summary>
    public string characterParentObject = new SendResult().GetResponseFileName();
    ...
    void Start(){
        ...
        Debug.Log("characterParentObjectStart" + characterParentObject);
        if(characterParentObject.Contains(GhostStr) && !characterParentObject.Contains(Mii)){
    ...
    /// </summary>
    public void Bell(){
        parentObject = GameObject.Find(characterParentObject);
        Debug.Log("characterParentObject" + characterParentObject);
